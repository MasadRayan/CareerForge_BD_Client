...
import { FileSearch, BrainCircuit, WandSparkles, Route, Mic } from "lucide-react";
          ...
          {features.map((feature,index)=>{
            ...
            return (
              ...
              >
                ...
                <div className={`absolute inset-0 bg-gradient-to-br ${feature.style} opacity-0 transition duration-500 group-hover:opacity-100`} />



                {/* Number */}

                <span className={`absolute right-4 top-3 text-5xl font-bold opacity-10 ${isDark ? "text-white" : "text-slate-900"}`}>
                  0{index+1}
                </span>
                ...
                <h3 className={`relative text-lg font-bold ${isDark ? "text-white" : "text-slate-900"}`}>
                  {feature.title}
                </h3>
                ...
                <p className={`relative mt-2 text-sm leading-6 ${isDark ? "text-slate-400" : "text-slate-600"}`}>
                  {feature.text}
                </p>
